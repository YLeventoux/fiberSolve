...
function fiberGUI
    ...
    % Input fields
    uilabel(fig,'Text','Core diameter (um):','Position',[20 310 160 22]);
    dCoreField = uieditfield(fig,'numeric','Position',[200 310 100 22],'Value',8.2);

    uilabel(fig,'Text','Wavelength (um):','Position',[20 270 160 22]);
...
function calculate(dCoreField,lambdaField,typeMenu,valueField,fig)
    ...
    txt = sprintf(['n1 = %.6f, n2 = %.6f\n' ...
                   'neff = %.6f\n' ...
                   'MFD (Gaussian 1/e²) = %.3f um\n' ...
                   'MFD (Petermann 2)  = %.3f um\n' ...
                   'MFD (near-field rms) = %.3f um\n' ...
                   'Aeff (pi*w0²)  = %.3f um²\n' ...
                   'Aeff (field integral)  = %.3f um²\n' ...
                   'V-number = %.3f'], ...
